...
def timingAndPerformance():
    ...
    print("[7]: Go back")
    timingAndPerformanceSelection = raw_input("Please make a selection between 1-6: ")
...
def nseScripts():
    ...
    print("[14]: Go back")
    nseScriptsSelection = raw_input("Please make a selection between 1-14: ")
...
def firewallIdsEvasionAndSpoofing():
    ...
    print("[9]: Go back")
    fireEvasion = raw_input("Please make a selection between 1-9:")
...
def NMAPoutput():
    ...
    print("[17]: Go back")
    outputChoice = raw_input("Please make a selection between 1-17: ")
    if outputChoice == 1:
...
def otherUsefulNmapCommands():
    ...
    print("[4]: Go back")
    otherUsefulSelection = raw_input("Please enter a choice between 1-4: ")
